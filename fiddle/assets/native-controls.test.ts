...
describe("visual controls serialize native requests", () => {
  it("uses native resize modes and automatic dimensions", () => {
...
describe("deep links and edits", () => {
  ...
  it("populates restored widgets from a native URL", () => {
  ...
  it("changes only the edited control and preserves unrepresented native options", () => {
