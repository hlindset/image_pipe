defmodule ImagePipe.Native.ConfigTest do
  ...
  test "merges sparse output maps and encoder structs onto native defaults" do
    config =
      Config.validate!(
  ...
  test "rejects retired host controls now owned by native request options" do
  ...
  property "quality overrides preserve unrelated native defaults" do
