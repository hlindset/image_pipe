defmodule ImagePipe.RequestSafetyTest.InvalidPipelinePlanDialect do
  @moduledoc false
  # A declarative dialect whose plan carries an unusable pipeline — a shape a
  # host `parse_plan/2` can emit, and which the tier must reject before it
  # resolves a source identity, reads the cache, or touches an origin.
