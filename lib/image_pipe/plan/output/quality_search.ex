defmodule ImagePipe.Plan.Output.QualitySearch do
  ...
  (`ImagePipe.API.Config` seeds `autoquality_target`/`autoquality_allowed_error` for
  ...
  `autoquality_allowed_error` maps (what `ImagePipe.API.Config.validate!/1` produces) —
